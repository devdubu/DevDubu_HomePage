<template>
  <div>
    <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32 rounded-xl">
      <img src="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&crop=focalpoint&fp-y=.8&w=2830&h=1500&q=80&blend=111827&sat=-100&exp=15&blend-mode=multiply" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover object-right md:object-center rounded-lg" />
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
          <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">DevDubu</h2>
          <p class="mt-6 text-lg leading-8 text-gray-300">
            개발자 두부의 풀스택 기록과 기타 여러 일상들을 볼 수 있는 자체 제작 블로그 입니다.<br>
            해당 홈페이지는 여러 최신 기술을 적용하고 테스트 하기 위해서 제작 되었습니다.
          </p>
        </div>
    ...
    <div class="bg-white py-24 sm:py-16">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:max-w-4xl">
          <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">DevOps</h2>
          <p class="mt-2 text-lg leading-8 text-gray-600">개발자 두부의 DevOps</p>
          <Card/>
        </div>
      </div>
    </div>
...
const stats = [
  { name: '총 포스팅 수', value: '12' },
  { name: '사용 기술 스택 수', value: '300+' },
]
